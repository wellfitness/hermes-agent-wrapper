 ...
 *
 * NOTA DE PARIDAD: este transporte es copia literal del de `hermes-web`
 * (`../../hermes-web/src/acpClient.ts`). Es código Node puro (child_process +
 * readline), sin dependencia del editor. Si se corrige un bug aquí, replicarlo
 * allá (y viceversa).
 */
